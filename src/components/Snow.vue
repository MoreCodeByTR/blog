...
<div>
  ...
  <el-step v-for="item in list" :key="item.id"  :title="item.value" ></el-step>
</el-steps>
  ...
  <p>{{count}}</p>
  <el-button  type="primary" round @click="addCount()">count++</el-button>
  <p>{{rate}}</p>
  <el-button type="primary" round @click="addRate()">rate++</el-button>
  <p>{{total}}</p>
</div>
</template>
<script>
